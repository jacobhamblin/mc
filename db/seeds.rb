...
Pack.create!({author_id: 11, title: 'Limpid Haze', url: 'https://s3-us-west-1.amazonaws.com/afcojor/packs/Limpid+Haze.zip', prev: 'http://i.ytimg.com/vi/VxPrqY5d5tc/maxresdefault.jpg'})
Pack.create!({author_id: 12, title: 'Shockingly Simple', url: 'https://s3-us-west-1.amazonaws.com/afcojor/packs/%23ShockinglySimple+v2.8.zip', prev: 'http://cdn.resourcepack.net/images/2015/02/Shockingly-Simple-Resource-Pack-FOR-MINECRAFT-1.jpg'})
Pack.create!({author_id: 13, title: 'Mini City', url: 'https://s3-us-west-1.amazonaws.com/afcojor/packs/minicitypack8584592.zip', prev: 'http://cdn.resourcepack.net/images/2015/04/Mini-City-Resource-Pack-for-minecraft-1.jpg'})
Pack.create!({author_id: 14, title: 'Soulbound', url: 'https://s3-us-west-1.amazonaws.com/afcojor/packs/SoulBound-Pack-1.8.zip', prev: 'http://file-minecraft.com/wp-content/uploads/2015/04/Soulbound-resource-pack.jpg'})
...
Image.create!({url: 'http://cdn.resourcepack.net/images/2014/08/Limpid-Haze-Resource-Pack-for-minecraft-7.jpg', imageable_id: 11, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2014/08/Limpid-Haze-Resource-Pack-for-minecraft-5.jpg', imageable_id: 11, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2014/08/Limpid-Haze-Resource-Pack-for-minecraft-1.jpg', imageable_id: 11, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/02/Shockingly-Simple-Resource-Pack-FOR-MINECRAFT-2.jpg', imageable_id: 12, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/02/Shockingly-Simple-Resource-Pack-FOR-MINECRAFT-4.jpg', imageable_id: 12, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/02/Shockingly-Simple-Resource-Pack-FOR-MINECRAFT-3.jpg', imageable_id: 12, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/04/Mini-City-Resource-Pack-for-minecraft-4.jpg', imageable_id: 13, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/04/Mini-City-Resource-Pack-for-minecraft-4.jpg', imageable_id: 13, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/04/Mini-City-Resource-Pack-for-minecraft-2.jpg', imageable_id: 13, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/04/SoulBound-Resource-Pack-for-minecraft-1.jpg', imageable_id: 14, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/04/SoulBound-Resource-Pack-for-minecraft-2.jpg', imageable_id: 14, imageable_type: 'Pack'})
Image.create!({url: 'http://cdn.resourcepack.net/images/2015/04/SoulBound-Resource-Pack-for-minecraft-3.jpg', imageable_id: 14, imageable_type: 'Pack'})
